...
public class InventoryManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (addToInventoryButton != null)
            addToInventoryButton.onClick.AddListener(AddCurrentItemToInventory);

        if (craftButton != null)
            craftButton.onClick.AddListener(ToggleCraftPanel);

        if (craftCampfireButton != null)
            craftCampfireButton.onClick.AddListener(CraftCampfire);

        if (craftTorchButton != null)
            craftTorchButton.onClick.AddListener(CraftTorch);
    ...
    private void UpdateInventoryUI()
    {
        ...
        if (waterCountText != null)
            waterCountText.text = "Water: " + waterCount;
    }
    ...
    private void CraftCampfire()
    {
        ...
        {
            Debug.LogWarning("Campfire prefab sau spawn point lipsesc din Inspector!");
            return;
        }
    ...
    private void CraftTorch()
    {
        ...
        {
            Debug.LogWarning("Torch prefab sau hand point lipsesc din Inspector!");
            return;
        }
